...
#endif
public:
 Standard_EXPORT Standard_ConstructionError():Standard_DomainError(){}
 Standard_EXPORT Standard_ConstructionError(const Standard_CString AString):Standard_DomainError(AString){}
 ...
 Standard_EXPORT static Handle(Standard_ConstructionError) NewInstance(const Standard_CString aMessage); 

// Standard_EXPORT ~Standard_ConstructionError();

 // Type methods
 //
 Standard_EXPORT friend Handle_Standard_Type& Standard_ConstructionError_Type_();
