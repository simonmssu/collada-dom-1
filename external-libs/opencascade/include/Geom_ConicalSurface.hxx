...
//!   O + (R + v*tan(Ang)) * (cos(u)*XDir + sin(u)*YDir) + v*ZDir where: <br>
...
//!  returns the semi-angle of the conical surface ]0.0, PI/[. <br>
...
//! coordinate V in the local coordinate system of this <br>
...
//!  P (U, V) = Loc + (RefRadius + V * tan (Semi-Angle)) * <br>
//!             (cos (U) * XDir + sin (U) * YDir) +  V * ZDir <br>
