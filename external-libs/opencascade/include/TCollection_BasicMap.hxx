...
Standard_EXPORT   Standard_Boolean BeginResize(const Standard_Integer NbBuckets,Standard_Integer& NewBuckets,TCollection_MapNodePtr& data1,TCollection_MapNodePtr& data2) const;
...
Standard_EXPORT   void EndResize(const Standard_Integer NbBuckets,const Standard_Integer NewBuckets,const TCollection_MapNodePtr& data1,const TCollection_MapNodePtr& data2) ;
