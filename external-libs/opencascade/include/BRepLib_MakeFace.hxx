...
//! <br>
//!    Note :  When building a face from  a surface the surface <br>
//!    must  be C2. When a surface  is not C2  a  shell may  be <br>
//!    built using the class MakeShell from BRepLib. <br>
