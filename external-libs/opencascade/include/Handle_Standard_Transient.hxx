 ...
 *
 * Note that Handle should never be initislized by pointer to object
...
public:
  ...
  Standard_EXPORT static const Handle(Standard_Transient) DownCast(const Handle(Standard_Transient)& AnObject);
