...
//! See method below for information <br>
Standard_EXPORT   Standard_Boolean FixAddPCurve(const TopoDS_Edge& edge,const Handle(ShapeAnalysis_Surface)& surface,const TopLoc_Location& location,const Standard_Boolean isSeam,const Standard_Real prec = 0.0) ;
