...
#endif
public:
 Standard_EXPORT Standard_RangeError():Standard_DomainError(){}
 Standard_EXPORT Standard_RangeError(const Standard_CString AString):Standard_DomainError(AString){}
 ...
 Standard_EXPORT static Handle(Standard_RangeError) NewInstance(const Standard_CString aMessage); 
