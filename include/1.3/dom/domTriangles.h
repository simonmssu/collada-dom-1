...
{
public:
	COLLADA_TYPE::TypeEnum getElementType() const { return COLLADA_TYPE::TRIANGLES; }
public:
	class domP;
 ...
 * a URL  expression, bound to the triangles. If the material attribute is
...
protected:
	 ...
	 * Constructor
	 */
	domTriangles() : attrCount(), attrMaterial(), elemParam_array(), elemInput_array(), elemP_array() {}
	/**
	 * Destructor
	 */
