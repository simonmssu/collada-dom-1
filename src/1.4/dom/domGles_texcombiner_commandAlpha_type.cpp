...
daeElementRef
domGles_texcombiner_commandAlpha_type::create(daeInt)
{
	domGles_texcombiner_commandAlpha_typeRef ref = new domGles_texcombiner_commandAlpha_type;
	return ref;
}
...
domGles_texcombiner_commandAlpha_type::registerElement()
{
	...
	_Meta->registerClass(domGles_texcombiner_commandAlpha_type::create, &_Meta);
