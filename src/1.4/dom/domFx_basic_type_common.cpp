...
{
	domFx_basic_type_commonRef ref = new(bytes) domFx_basic_type_common;
	return ref;
}


daeMetaElement *
domFx_basic_type_common::registerElement()
{
    ...
    _Meta->addCMDataArray(daeOffsetOf(domFx_basic_type_common,_CMData), 1);	
	
	_Meta->setElementSize(sizeof(domFx_basic_type_common));
	_Meta->validate();
...
daeElementRef
domFx_basic_type_common::domBool::create(daeInt bytes)
{
	domFx_basic_type_common::domBoolRef ref = new(bytes) domFx_basic_type_common::domBool;
	return ref;
}


daeMetaElement *
domFx_basic_type_common::domBool::registerElement()
{
    if ( _Meta != NULL ) return _Meta;
	...
	_Meta->setElementSize(sizeof(domFx_basic_type_common::domBool));
	_Meta->validate();
...
daeElementRef
domFx_basic_type_common::domBool2::create(daeInt bytes)
{
	domFx_basic_type_common::domBool2Ref ref = new(bytes) domFx_basic_type_common::domBool2;
	return ref;
}


daeMetaElement *
domFx_basic_type_common::domBool2::registerElement()
{
    if ( _Meta != NULL ) return _Meta;
	...
	_Meta->setElementSize(sizeof(domFx_basic_type_common::domBool2));
	_Meta->validate();
...
daeElementRef
domFx_basic_type_common::domBool3::create(daeInt bytes)
{
	domFx_basic_type_common::domBool3Ref ref = new(bytes) domFx_basic_type_common::domBool3;
	return ref;
}
...
domFx_basic_type_common::domBool3::registerElement()
{
	...
	_Meta->setElementSize(sizeof(domFx_basic_type_common::domBool3));
	_Meta->validate();
...
daeElementRef
domFx_basic_type_common::domBool4::create(daeInt bytes)
{
	domFx_basic_type_common::domBool4Ref ref = new(bytes) domFx_basic_type_common::domBool4;
	return ref;
}


daeMetaElement *
domFx_basic_type_common::domBool4::registerElement()
{
    if ( _Meta != NULL ) return _Meta;
	...
	_Meta->setElementSize(sizeof(domFx_basic_type_common::domBool4));
	_Meta->validate();
...
daeElementRef
domFx_basic_type_common::domInt::create(daeInt bytes)
{
	domFx_basic_type_common::domIntRef ref = new(bytes) domFx_basic_type_common::domInt;
	return ref;
}


daeMetaElement *
domFx_basic_type_common::domInt::registerElement()
{
    if ( _Meta != NULL ) return _Meta;
	...
	_Meta->setElementSize(sizeof(domFx_basic_type_common::domInt));
	_Meta->validate();
...
daeElementRef
domFx_basic_type_common::domInt2::create(daeInt bytes)
{
	domFx_basic_type_common::domInt2Ref ref = new(bytes) domFx_basic_type_common::domInt2;
	return ref;
}


daeMetaElement *
domFx_basic_type_common::domInt2::registerElement()
{
    if ( _Meta != NULL ) return _Meta;
	...
	_Meta->setElementSize(sizeof(domFx_basic_type_common::domInt2));
	_Meta->validate();
...
daeElementRef
domFx_basic_type_common::domInt3::create(daeInt bytes)
{
	domFx_basic_type_common::domInt3Ref ref = new(bytes) domFx_basic_type_common::domInt3;
	return ref;
}


daeMetaElement *
domFx_basic_type_common::domInt3::registerElement()
{
    if ( _Meta != NULL ) return _Meta;
	...
	_Meta->setElementSize(sizeof(domFx_basic_type_common::domInt3));
	_Meta->validate();
...
daeElementRef
domFx_basic_type_common::domInt4::create(daeInt bytes)
{
	domFx_basic_type_common::domInt4Ref ref = new(bytes) domFx_basic_type_common::domInt4;
	return ref;
}


daeMetaElement *
domFx_basic_type_common::domInt4::registerElement()
{
    if ( _Meta != NULL ) return _Meta;
	...
	_Meta->setElementSize(sizeof(domFx_basic_type_common::domInt4));
	_Meta->validate();
...
daeElementRef
domFx_basic_type_common::domFloat::create(daeInt bytes)
{
	domFx_basic_type_common::domFloatRef ref = new(bytes) domFx_basic_type_common::domFloat;
	return ref;
}
...
domFx_basic_type_common::domFloat::registerElement()
{
	...
	_Meta->setElementSize(sizeof(domFx_basic_type_common::domFloat));
	_Meta->validate();
...
daeElementRef
domFx_basic_type_common::domFloat2::create(daeInt bytes)
{
	domFx_basic_type_common::domFloat2Ref ref = new(bytes) domFx_basic_type_common::domFloat2;
	return ref;
}
...
domFx_basic_type_common::domFloat2::registerElement()
{
	...
	_Meta->setElementSize(sizeof(domFx_basic_type_common::domFloat2));
	_Meta->validate();
...
daeElementRef
domFx_basic_type_common::domFloat3::create(daeInt bytes)
{
	domFx_basic_type_common::domFloat3Ref ref = new(bytes) domFx_basic_type_common::domFloat3;
	return ref;
}


daeMetaElement *
domFx_basic_type_common::domFloat3::registerElement()
{
    if ( _Meta != NULL ) return _Meta;
	...
	_Meta->setElementSize(sizeof(domFx_basic_type_common::domFloat3));
	_Meta->validate();
...
daeElementRef
domFx_basic_type_common::domFloat4::create(daeInt bytes)
{
	domFx_basic_type_common::domFloat4Ref ref = new(bytes) domFx_basic_type_common::domFloat4;
	return ref;
}


daeMetaElement *
domFx_basic_type_common::domFloat4::registerElement()
{
    if ( _Meta != NULL ) return _Meta;
	...
	_Meta->setElementSize(sizeof(domFx_basic_type_common::domFloat4));
	_Meta->validate();
...
daeElementRef
domFx_basic_type_common::domFloat1x1::create(daeInt bytes)
{
	domFx_basic_type_common::domFloat1x1Ref ref = new(bytes) domFx_basic_type_common::domFloat1x1;
	return ref;
}


daeMetaElement *
domFx_basic_type_common::domFloat1x1::registerElement()
{
    if ( _Meta != NULL ) return _Meta;
	...
	_Meta->setElementSize(sizeof(domFx_basic_type_common::domFloat1x1));
	_Meta->validate();
...
daeElementRef
domFx_basic_type_common::domFloat1x2::create(daeInt bytes)
{
	domFx_basic_type_common::domFloat1x2Ref ref = new(bytes) domFx_basic_type_common::domFloat1x2;
	return ref;
}


daeMetaElement *
domFx_basic_type_common::domFloat1x2::registerElement()
{
    if ( _Meta != NULL ) return _Meta;
	...
	_Meta->setElementSize(sizeof(domFx_basic_type_common::domFloat1x2));
	_Meta->validate();
...
daeElementRef
domFx_basic_type_common::domFloat1x3::create(daeInt bytes)
{
	domFx_basic_type_common::domFloat1x3Ref ref = new(bytes) domFx_basic_type_common::domFloat1x3;
	return ref;
}


daeMetaElement *
domFx_basic_type_common::domFloat1x3::registerElement()
{
    if ( _Meta != NULL ) return _Meta;
	...
	_Meta->setElementSize(sizeof(domFx_basic_type_common::domFloat1x3));
	_Meta->validate();
...
daeElementRef
domFx_basic_type_common::domFloat1x4::create(daeInt bytes)
{
	domFx_basic_type_common::domFloat1x4Ref ref = new(bytes) domFx_basic_type_common::domFloat1x4;
	return ref;
}


daeMetaElement *
domFx_basic_type_common::domFloat1x4::registerElement()
{
    if ( _Meta != NULL ) return _Meta;
	...
	_Meta->setElementSize(sizeof(domFx_basic_type_common::domFloat1x4));
	_Meta->validate();
...
daeElementRef
domFx_basic_type_common::domFloat2x1::create(daeInt bytes)
{
	domFx_basic_type_common::domFloat2x1Ref ref = new(bytes) domFx_basic_type_common::domFloat2x1;
	return ref;
}


daeMetaElement *
domFx_basic_type_common::domFloat2x1::registerElement()
{
    if ( _Meta != NULL ) return _Meta;
	...
	_Meta->setElementSize(sizeof(domFx_basic_type_common::domFloat2x1));
	_Meta->validate();
...
daeElementRef
domFx_basic_type_common::domFloat2x2::create(daeInt bytes)
{
	domFx_basic_type_common::domFloat2x2Ref ref = new(bytes) domFx_basic_type_common::domFloat2x2;
	return ref;
}
...
domFx_basic_type_common::domFloat2x2::registerElement()
{
	...
	_Meta->setElementSize(sizeof(domFx_basic_type_common::domFloat2x2));
	_Meta->validate();
...
daeElementRef
domFx_basic_type_common::domFloat2x3::create(daeInt bytes)
{
	domFx_basic_type_common::domFloat2x3Ref ref = new(bytes) domFx_basic_type_common::domFloat2x3;
	return ref;
}


daeMetaElement *
domFx_basic_type_common::domFloat2x3::registerElement()
{
    if ( _Meta != NULL ) return _Meta;
	...
	_Meta->setElementSize(sizeof(domFx_basic_type_common::domFloat2x3));
	_Meta->validate();
...
daeElementRef
domFx_basic_type_common::domFloat2x4::create(daeInt bytes)
{
	domFx_basic_type_common::domFloat2x4Ref ref = new(bytes) domFx_basic_type_common::domFloat2x4;
	return ref;
}


daeMetaElement *
domFx_basic_type_common::domFloat2x4::registerElement()
{
    if ( _Meta != NULL ) return _Meta;
	...
	_Meta->setElementSize(sizeof(domFx_basic_type_common::domFloat2x4));
	_Meta->validate();
...
daeElementRef
domFx_basic_type_common::domFloat3x1::create(daeInt bytes)
{
	domFx_basic_type_common::domFloat3x1Ref ref = new(bytes) domFx_basic_type_common::domFloat3x1;
	return ref;
}


daeMetaElement *
domFx_basic_type_common::domFloat3x1::registerElement()
{
    if ( _Meta != NULL ) return _Meta;
	...
	_Meta->setElementSize(sizeof(domFx_basic_type_common::domFloat3x1));
	_Meta->validate();
...
daeElementRef
domFx_basic_type_common::domFloat3x2::create(daeInt bytes)
{
	domFx_basic_type_common::domFloat3x2Ref ref = new(bytes) domFx_basic_type_common::domFloat3x2;
	return ref;
}


daeMetaElement *
domFx_basic_type_common::domFloat3x2::registerElement()
{
    if ( _Meta != NULL ) return _Meta;
	...
	_Meta->setElementSize(sizeof(domFx_basic_type_common::domFloat3x2));
	_Meta->validate();
...
daeElementRef
domFx_basic_type_common::domFloat3x3::create(daeInt bytes)
{
	domFx_basic_type_common::domFloat3x3Ref ref = new(bytes) domFx_basic_type_common::domFloat3x3;
	return ref;
}


daeMetaElement *
domFx_basic_type_common::domFloat3x3::registerElement()
{
    if ( _Meta != NULL ) return _Meta;
	...
	_Meta->setElementSize(sizeof(domFx_basic_type_common::domFloat3x3));
	_Meta->validate();
...
daeElementRef
domFx_basic_type_common::domFloat3x4::create(daeInt bytes)
{
	domFx_basic_type_common::domFloat3x4Ref ref = new(bytes) domFx_basic_type_common::domFloat3x4;
	return ref;
}


daeMetaElement *
domFx_basic_type_common::domFloat3x4::registerElement()
{
    if ( _Meta != NULL ) return _Meta;
	...
	_Meta->setElementSize(sizeof(domFx_basic_type_common::domFloat3x4));
	_Meta->validate();
...
daeElementRef
domFx_basic_type_common::domFloat4x1::create(daeInt bytes)
{
	domFx_basic_type_common::domFloat4x1Ref ref = new(bytes) domFx_basic_type_common::domFloat4x1;
	return ref;
}


daeMetaElement *
domFx_basic_type_common::domFloat4x1::registerElement()
{
    if ( _Meta != NULL ) return _Meta;
	...
	_Meta->setElementSize(sizeof(domFx_basic_type_common::domFloat4x1));
	_Meta->validate();
...
daeElementRef
domFx_basic_type_common::domFloat4x2::create(daeInt bytes)
{
	domFx_basic_type_common::domFloat4x2Ref ref = new(bytes) domFx_basic_type_common::domFloat4x2;
	return ref;
}


daeMetaElement *
domFx_basic_type_common::domFloat4x2::registerElement()
{
    if ( _Meta != NULL ) return _Meta;
	...
	_Meta->setElementSize(sizeof(domFx_basic_type_common::domFloat4x2));
	_Meta->validate();
...
daeElementRef
domFx_basic_type_common::domFloat4x3::create(daeInt bytes)
{
	domFx_basic_type_common::domFloat4x3Ref ref = new(bytes) domFx_basic_type_common::domFloat4x3;
	return ref;
}


daeMetaElement *
domFx_basic_type_common::domFloat4x3::registerElement()
{
    if ( _Meta != NULL ) return _Meta;
	...
	_Meta->setElementSize(sizeof(domFx_basic_type_common::domFloat4x3));
	_Meta->validate();
...
daeElementRef
domFx_basic_type_common::domFloat4x4::create(daeInt bytes)
{
	domFx_basic_type_common::domFloat4x4Ref ref = new(bytes) domFx_basic_type_common::domFloat4x4;
	return ref;
}


daeMetaElement *
domFx_basic_type_common::domFloat4x4::registerElement()
{
    if ( _Meta != NULL ) return _Meta;
	...
	_Meta->setElementSize(sizeof(domFx_basic_type_common::domFloat4x4));
	_Meta->validate();
...
daeElementRef
domFx_basic_type_common::domEnum::create(daeInt bytes)
{
	domFx_basic_type_common::domEnumRef ref = new(bytes) domFx_basic_type_common::domEnum;
	return ref;
}


daeMetaElement *
domFx_basic_type_common::domEnum::registerElement()
{
    if ( _Meta != NULL ) return _Meta;
	...
	_Meta->setElementSize(sizeof(domFx_basic_type_common::domEnum));
	_Meta->validate();
...
daeMetaElement * domFx_basic_type_common::_Meta = NULL;
daeMetaElement * domFx_basic_type_common::domBool::_Meta = NULL;
daeMetaElement * domFx_basic_type_common::domBool2::_Meta = NULL;
daeMetaElement * domFx_basic_type_common::domBool3::_Meta = NULL;
daeMetaElement * domFx_basic_type_common::domBool4::_Meta = NULL;
daeMetaElement * domFx_basic_type_common::domInt::_Meta = NULL;
daeMetaElement * domFx_basic_type_common::domInt2::_Meta = NULL;
daeMetaElement * domFx_basic_type_common::domInt3::_Meta = NULL;
daeMetaElement * domFx_basic_type_common::domInt4::_Meta = NULL;
daeMetaElement * domFx_basic_type_common::domFloat::_Meta = NULL;
daeMetaElement * domFx_basic_type_common::domFloat2::_Meta = NULL;
daeMetaElement * domFx_basic_type_common::domFloat3::_Meta = NULL;
daeMetaElement * domFx_basic_type_common::domFloat4::_Meta = NULL;
daeMetaElement * domFx_basic_type_common::domFloat1x1::_Meta = NULL;
daeMetaElement * domFx_basic_type_common::domFloat1x2::_Meta = NULL;
daeMetaElement * domFx_basic_type_common::domFloat1x3::_Meta = NULL;
daeMetaElement * domFx_basic_type_common::domFloat1x4::_Meta = NULL;
daeMetaElement * domFx_basic_type_common::domFloat2x1::_Meta = NULL;
daeMetaElement * domFx_basic_type_common::domFloat2x2::_Meta = NULL;
daeMetaElement * domFx_basic_type_common::domFloat2x3::_Meta = NULL;
daeMetaElement * domFx_basic_type_common::domFloat2x4::_Meta = NULL;
daeMetaElement * domFx_basic_type_common::domFloat3x1::_Meta = NULL;
daeMetaElement * domFx_basic_type_common::domFloat3x2::_Meta = NULL;
daeMetaElement * domFx_basic_type_common::domFloat3x3::_Meta = NULL;
daeMetaElement * domFx_basic_type_common::domFloat3x4::_Meta = NULL;
daeMetaElement * domFx_basic_type_common::domFloat4x1::_Meta = NULL;
daeMetaElement * domFx_basic_type_common::domFloat4x2::_Meta = NULL;
daeMetaElement * domFx_basic_type_common::domFloat4x3::_Meta = NULL;
daeMetaElement * domFx_basic_type_common::domFloat4x4::_Meta = NULL;
daeMetaElement * domFx_basic_type_common::domEnum::_Meta = NULL;
