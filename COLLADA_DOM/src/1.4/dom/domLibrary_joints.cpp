...
daeElementRef
domLibrary_joints::create(daeInt)
{
	domLibrary_jointsRef ref = new domLibrary_joints;
	return ref;
}


daeMetaElement *
domLibrary_joints::registerElement()
{
    if ( _Meta != NULL ) return _Meta;
    
    _Meta = new daeMetaElement;
    _Meta->setName( "library_joints" );
	_Meta->registerClass(domLibrary_joints::create, &_Meta);
	...
	_Meta->setElementSize(sizeof(domLibrary_joints));
	_Meta->validate();
...
daeMetaElement * domLibrary_joints::_Meta = NULL;
