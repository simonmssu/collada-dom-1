...
daeElementRef
domFx_sampler3D_common::create(daeInt)
{
...
domFx_sampler3D_common::registerElement()
{
	...
	_Meta->registerClass(domFx_sampler3D_common::create, &_Meta);
...
daeElementRef
domFx_sampler3D_common::domSource::create(daeInt)
{
...
domFx_sampler3D_common::domSource::registerElement()
{
	...
	_Meta->registerClass(domFx_sampler3D_common::domSource::create, &_Meta);
...
daeElementRef
domFx_sampler3D_common::domWrap_s::create(daeInt)
{
...
domFx_sampler3D_common::domWrap_s::registerElement()
{
	...
	_Meta->registerClass(domFx_sampler3D_common::domWrap_s::create, &_Meta);
...
daeElementRef
domFx_sampler3D_common::domWrap_t::create(daeInt)
{
...
domFx_sampler3D_common::domWrap_t::registerElement()
{
	...
	_Meta->registerClass(domFx_sampler3D_common::domWrap_t::create, &_Meta);
...
daeElementRef
domFx_sampler3D_common::domWrap_p::create(daeInt)
{
...
domFx_sampler3D_common::domWrap_p::registerElement()
{
	...
	_Meta->registerClass(domFx_sampler3D_common::domWrap_p::create, &_Meta);
...
daeElementRef
domFx_sampler3D_common::domMinfilter::create(daeInt)
{
...
domFx_sampler3D_common::domMinfilter::registerElement()
{
	...
	_Meta->registerClass(domFx_sampler3D_common::domMinfilter::create, &_Meta);
...
daeElementRef
domFx_sampler3D_common::domMagfilter::create(daeInt)
{
...
domFx_sampler3D_common::domMagfilter::registerElement()
{
	...
	_Meta->registerClass(domFx_sampler3D_common::domMagfilter::create, &_Meta);
...
daeElementRef
domFx_sampler3D_common::domMipfilter::create(daeInt)
{
...
domFx_sampler3D_common::domMipfilter::registerElement()
{
	...
	_Meta->registerClass(domFx_sampler3D_common::domMipfilter::create, &_Meta);
...
daeElementRef
domFx_sampler3D_common::domBorder_color::create(daeInt)
{
...
domFx_sampler3D_common::domBorder_color::registerElement()
{
	...
	_Meta->registerClass(domFx_sampler3D_common::domBorder_color::create, &_Meta);
...
daeElementRef
domFx_sampler3D_common::domMipmap_maxlevel::create(daeInt)
{
...
domFx_sampler3D_common::domMipmap_maxlevel::registerElement()
{
	...
	_Meta->registerClass(domFx_sampler3D_common::domMipmap_maxlevel::create, &_Meta);
...
daeElementRef
domFx_sampler3D_common::domMipmap_bias::create(daeInt)
{
...
domFx_sampler3D_common::domMipmap_bias::registerElement()
{
	...
	_Meta->registerClass(domFx_sampler3D_common::domMipmap_bias::create, &_Meta);
