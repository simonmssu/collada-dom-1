...
daeElementRef
domFx_sampler1D_common::create(daeInt)
{
	domFx_sampler1D_commonRef ref = new domFx_sampler1D_common;
	return ref;
}
...
domFx_sampler1D_common::registerElement()
{
	...
	_Meta->registerClass(domFx_sampler1D_common::create, &_Meta);
...
daeElementRef
domFx_sampler1D_common::domSource::create(daeInt)
{
	domFx_sampler1D_common::domSourceRef ref = new domFx_sampler1D_common::domSource;
	return ref;
}
...
domFx_sampler1D_common::domSource::registerElement()
{
	...
	_Meta->registerClass(domFx_sampler1D_common::domSource::create, &_Meta);
...
daeElementRef
domFx_sampler1D_common::domWrap_s::create(daeInt)
{
	domFx_sampler1D_common::domWrap_sRef ref = new domFx_sampler1D_common::domWrap_s;
	return ref;
}
...
domFx_sampler1D_common::domWrap_s::registerElement()
{
	...
	_Meta->registerClass(domFx_sampler1D_common::domWrap_s::create, &_Meta);
...
daeElementRef
domFx_sampler1D_common::domMinfilter::create(daeInt)
{
	domFx_sampler1D_common::domMinfilterRef ref = new domFx_sampler1D_common::domMinfilter;
	return ref;
}
...
domFx_sampler1D_common::domMinfilter::registerElement()
{
	...
	_Meta->registerClass(domFx_sampler1D_common::domMinfilter::create, &_Meta);
...
daeElementRef
domFx_sampler1D_common::domMagfilter::create(daeInt)
{
	domFx_sampler1D_common::domMagfilterRef ref = new domFx_sampler1D_common::domMagfilter;
	return ref;
}
...
domFx_sampler1D_common::domMagfilter::registerElement()
{
	...
	_Meta->registerClass(domFx_sampler1D_common::domMagfilter::create, &_Meta);
...
daeElementRef
domFx_sampler1D_common::domMipfilter::create(daeInt)
{
	domFx_sampler1D_common::domMipfilterRef ref = new domFx_sampler1D_common::domMipfilter;
	return ref;
}
...
domFx_sampler1D_common::domMipfilter::registerElement()
{
	...
	_Meta->registerClass(domFx_sampler1D_common::domMipfilter::create, &_Meta);
...
daeElementRef
domFx_sampler1D_common::domBorder_color::create(daeInt)
{
	domFx_sampler1D_common::domBorder_colorRef ref = new domFx_sampler1D_common::domBorder_color;
	return ref;
}
...
domFx_sampler1D_common::domBorder_color::registerElement()
{
	...
	_Meta->registerClass(domFx_sampler1D_common::domBorder_color::create, &_Meta);
...
daeElementRef
domFx_sampler1D_common::domMipmap_maxlevel::create(daeInt)
{
	domFx_sampler1D_common::domMipmap_maxlevelRef ref = new domFx_sampler1D_common::domMipmap_maxlevel;
	return ref;
}
...
domFx_sampler1D_common::domMipmap_maxlevel::registerElement()
{
	...
	_Meta->registerClass(domFx_sampler1D_common::domMipmap_maxlevel::create, &_Meta);
...
daeElementRef
domFx_sampler1D_common::domMipmap_bias::create(daeInt)
{
	domFx_sampler1D_common::domMipmap_biasRef ref = new domFx_sampler1D_common::domMipmap_bias;
	return ref;
}
...
domFx_sampler1D_common::domMipmap_bias::registerElement()
{
	...
	_Meta->registerClass(domFx_sampler1D_common::domMipmap_bias::create, &_Meta);
