...
daeElementRef
domLibrary_kinematics_scenes::create(daeInt)
{
	domLibrary_kinematics_scenesRef ref = new domLibrary_kinematics_scenes;
	return ref;
}


daeMetaElement *
domLibrary_kinematics_scenes::registerElement()
{
    if ( _Meta != NULL ) return _Meta;
    
    _Meta = new daeMetaElement;
    _Meta->setName( "library_kinematics_scenes" );
	_Meta->registerClass(domLibrary_kinematics_scenes::create, &_Meta);
	...
	mea->setElementType( domKinematics_scene::registerElement() );
	cm->appendChild( mea );
	...
	_Meta->setElementSize(sizeof(domLibrary_kinematics_scenes));
	_Meta->validate();
...
daeMetaElement * domLibrary_kinematics_scenes::_Meta = NULL;
