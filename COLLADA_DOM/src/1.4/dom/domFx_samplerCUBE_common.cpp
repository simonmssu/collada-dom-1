...
daeElementRef
domFx_samplerCUBE_common::create()
{
	domFx_samplerCUBE_commonRef ref = new domFx_samplerCUBE_common;
	return ref;
}
...
domFx_samplerCUBE_common::registerElement(DAE& dae)
{
	...
	meta->registerClass(domFx_samplerCUBE_common::create, &meta);
...
daeElementRef
domFx_samplerCUBE_common::domSource::create()
{
	domFx_samplerCUBE_common::domSourceRef ref = new domFx_samplerCUBE_common::domSource;
	return ref;
}
...
domFx_samplerCUBE_common::domSource::registerElement(DAE& dae)
{
	...
	dae.setMeta(getTypeStatic(), *meta);
	meta->setName( "source" );
	meta->registerClass(domFx_samplerCUBE_common::domSource::create, &meta);
...
daeElementRef
domFx_samplerCUBE_common::domWrap_s::create()
{
	domFx_samplerCUBE_common::domWrap_sRef ref = new domFx_samplerCUBE_common::domWrap_s;
	return ref;
}
...
domFx_samplerCUBE_common::domWrap_s::registerElement(DAE& dae)
{
	...
	dae.setMeta(getTypeStatic(), *meta);
	meta->setName( "wrap_s" );
	meta->registerClass(domFx_samplerCUBE_common::domWrap_s::create, &meta);
...
daeElementRef
domFx_samplerCUBE_common::domWrap_t::create()
{
	domFx_samplerCUBE_common::domWrap_tRef ref = new domFx_samplerCUBE_common::domWrap_t;
	return ref;
}
...
domFx_samplerCUBE_common::domWrap_t::registerElement(DAE& dae)
{
	...
	dae.setMeta(getTypeStatic(), *meta);
	meta->setName( "wrap_t" );
	meta->registerClass(domFx_samplerCUBE_common::domWrap_t::create, &meta);
...
daeElementRef
domFx_samplerCUBE_common::domWrap_p::create()
{
	domFx_samplerCUBE_common::domWrap_pRef ref = new domFx_samplerCUBE_common::domWrap_p;
	return ref;
}
...
domFx_samplerCUBE_common::domWrap_p::registerElement(DAE& dae)
{
	...
	dae.setMeta(getTypeStatic(), *meta);
	meta->setName( "wrap_p" );
	meta->registerClass(domFx_samplerCUBE_common::domWrap_p::create, &meta);
...
daeElementRef
domFx_samplerCUBE_common::domMinfilter::create()
{
	domFx_samplerCUBE_common::domMinfilterRef ref = new domFx_samplerCUBE_common::domMinfilter;
	return ref;
}
...
domFx_samplerCUBE_common::domMinfilter::registerElement(DAE& dae)
{
	...
	meta->registerClass(domFx_samplerCUBE_common::domMinfilter::create, &meta);
...
daeElementRef
domFx_samplerCUBE_common::domMagfilter::create()
{
	domFx_samplerCUBE_common::domMagfilterRef ref = new domFx_samplerCUBE_common::domMagfilter;
	return ref;
}
...
domFx_samplerCUBE_common::domMagfilter::registerElement(DAE& dae)
{
	...
	meta->registerClass(domFx_samplerCUBE_common::domMagfilter::create, &meta);
...
daeElementRef
domFx_samplerCUBE_common::domMipfilter::create()
{
	domFx_samplerCUBE_common::domMipfilterRef ref = new domFx_samplerCUBE_common::domMipfilter;
	return ref;
}
...
domFx_samplerCUBE_common::domMipfilter::registerElement(DAE& dae)
{
	...
	meta->registerClass(domFx_samplerCUBE_common::domMipfilter::create, &meta);
...
daeElementRef
domFx_samplerCUBE_common::domBorder_color::create()
{
	domFx_samplerCUBE_common::domBorder_colorRef ref = new domFx_samplerCUBE_common::domBorder_color;
	return ref;
}
...
domFx_samplerCUBE_common::domBorder_color::registerElement(DAE& dae)
{
	...
	meta->registerClass(domFx_samplerCUBE_common::domBorder_color::create, &meta);
...
daeElementRef
domFx_samplerCUBE_common::domMipmap_maxlevel::create()
{
	domFx_samplerCUBE_common::domMipmap_maxlevelRef ref = new domFx_samplerCUBE_common::domMipmap_maxlevel;
	return ref;
}
...
domFx_samplerCUBE_common::domMipmap_maxlevel::registerElement(DAE& dae)
{
	...
	meta->registerClass(domFx_samplerCUBE_common::domMipmap_maxlevel::create, &meta);
...
daeElementRef
domFx_samplerCUBE_common::domMipmap_bias::create()
{
	domFx_samplerCUBE_common::domMipmap_biasRef ref = new domFx_samplerCUBE_common::domMipmap_bias;
	return ref;
}
...
domFx_samplerCUBE_common::domMipmap_bias::registerElement(DAE& dae)
{
	...
	meta->registerClass(domFx_samplerCUBE_common::domMipmap_bias::create, &meta);
