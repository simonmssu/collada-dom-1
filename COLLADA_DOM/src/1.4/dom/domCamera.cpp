...
daeElementRef
domCamera::domOptics::domTechnique_common::create()
{
...
daeElementRef
domCamera::domOptics::domTechnique_common::domOrthographic::create()
{
...
daeElementRef
domCamera::domOptics::domTechnique_common::domPerspective::create()
{
