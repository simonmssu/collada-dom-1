...
daeElementRef
domLibrary_kinematics_models::create(daeInt)
{
	domLibrary_kinematics_modelsRef ref = new domLibrary_kinematics_models;
	return ref;
}
...
domLibrary_kinematics_models::registerElement()
{
    ...
    _Meta->setName( "library_kinematics_models" );
	_Meta->registerClass(domLibrary_kinematics_models::create, &_Meta);
	...
	mea->setElementType( domKinematics_model::registerElement() );
	cm->appendChild( mea );
	...
	_Meta->setElementSize(sizeof(domLibrary_kinematics_models));
	_Meta->validate();
...
daeMetaElement * domLibrary_kinematics_models::_Meta = NULL;
