...
domFx_sampler2D_common::registerElement(DAE& dae)
{
	...
	meta->registerClass(domFx_sampler2D_common::create, &meta);
...
daeElementRef
domFx_sampler2D_common::domSource::create()
{
...
domFx_sampler2D_common::domSource::registerElement(DAE& dae)
{
	...
	dae.setMeta(getTypeStatic(), *meta);
	meta->setName( "source" );
	meta->registerClass(domFx_sampler2D_common::domSource::create, &meta);
...
daeElementRef
domFx_sampler2D_common::domWrap_s::create()
{
...
domFx_sampler2D_common::domWrap_s::registerElement(DAE& dae)
{
	...
	dae.setMeta(getTypeStatic(), *meta);
	meta->setName( "wrap_s" );
	meta->registerClass(domFx_sampler2D_common::domWrap_s::create, &meta);
...
daeElementRef
domFx_sampler2D_common::domWrap_t::create()
{
...
domFx_sampler2D_common::domWrap_t::registerElement(DAE& dae)
{
	...
	dae.setMeta(getTypeStatic(), *meta);
	meta->setName( "wrap_t" );
	meta->registerClass(domFx_sampler2D_common::domWrap_t::create, &meta);
...
daeElementRef
domFx_sampler2D_common::domMinfilter::create()
{
...
domFx_sampler2D_common::domMinfilter::registerElement(DAE& dae)
{
	...
	meta->registerClass(domFx_sampler2D_common::domMinfilter::create, &meta);
...
daeElementRef
domFx_sampler2D_common::domMagfilter::create()
{
...
domFx_sampler2D_common::domMagfilter::registerElement(DAE& dae)
{
	...
	meta->registerClass(domFx_sampler2D_common::domMagfilter::create, &meta);
...
daeElementRef
domFx_sampler2D_common::domMipfilter::create()
{
...
domFx_sampler2D_common::domMipfilter::registerElement(DAE& dae)
{
	...
	meta->registerClass(domFx_sampler2D_common::domMipfilter::create, &meta);
...
daeElementRef
domFx_sampler2D_common::domBorder_color::create()
{
...
domFx_sampler2D_common::domBorder_color::registerElement(DAE& dae)
{
	...
	meta->registerClass(domFx_sampler2D_common::domBorder_color::create, &meta);
...
daeElementRef
domFx_sampler2D_common::domMipmap_maxlevel::create()
{
...
domFx_sampler2D_common::domMipmap_maxlevel::registerElement(DAE& dae)
{
	...
	meta->registerClass(domFx_sampler2D_common::domMipmap_maxlevel::create, &meta);
...
daeElementRef
domFx_sampler2D_common::domMipmap_bias::create()
{
...
domFx_sampler2D_common::domMipmap_bias::registerElement(DAE& dae)
{
	...
	meta->registerClass(domFx_sampler2D_common::domMipmap_bias::create, &meta);
