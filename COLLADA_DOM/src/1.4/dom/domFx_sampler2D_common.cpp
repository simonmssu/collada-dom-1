...
domFx_sampler2D_common::registerElement()
{
	...
	_Meta->registerClass(domFx_sampler2D_common::create, &_Meta);
...
domFx_sampler2D_common::domSource::registerElement()
{
	...
	_Meta->registerClass(domFx_sampler2D_common::domSource::create, &_Meta);
...
domFx_sampler2D_common::domWrap_s::registerElement()
{
	...
	_Meta->registerClass(domFx_sampler2D_common::domWrap_s::create, &_Meta);
...
domFx_sampler2D_common::domWrap_t::registerElement()
{
	...
	_Meta->registerClass(domFx_sampler2D_common::domWrap_t::create, &_Meta);
...
domFx_sampler2D_common::domMinfilter::registerElement()
{
	...
	_Meta->registerClass(domFx_sampler2D_common::domMinfilter::create, &_Meta);
...
domFx_sampler2D_common::domMagfilter::registerElement()
{
	...
	_Meta->registerClass(domFx_sampler2D_common::domMagfilter::create, &_Meta);
...
domFx_sampler2D_common::domMipfilter::registerElement()
{
	...
	_Meta->registerClass(domFx_sampler2D_common::domMipfilter::create, &_Meta);
...
domFx_sampler2D_common::domBorder_color::registerElement()
{
	...
	_Meta->registerClass(domFx_sampler2D_common::domBorder_color::create, &_Meta);
...
domFx_sampler2D_common::domMipmap_maxlevel::registerElement()
{
	...
	_Meta->registerClass(domFx_sampler2D_common::domMipmap_maxlevel::create, &_Meta);
...
domFx_sampler2D_common::domMipmap_bias::registerElement()
{
	...
	_Meta->registerClass(domFx_sampler2D_common::domMipmap_bias::create, &_Meta);
