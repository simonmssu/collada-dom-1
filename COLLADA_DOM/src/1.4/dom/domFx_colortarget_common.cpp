...
daeElementRef
domFx_colortarget_common::create(daeInt)
{
	domFx_colortarget_commonRef ref = new domFx_colortarget_common;
	return ref;
}
...
domFx_colortarget_common::registerElement()
{
	...
	_Meta->registerClass(domFx_colortarget_common::create, &_Meta);
