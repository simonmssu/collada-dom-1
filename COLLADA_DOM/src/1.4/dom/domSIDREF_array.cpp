...
daeElementRef
domSIDREF_array::create(daeInt)
{
	domSIDREF_arrayRef ref = new domSIDREF_array;
	return ref;
}


daeMetaElement *
domSIDREF_array::registerElement()
{
    if ( _Meta != NULL ) return _Meta;
    
    _Meta = new daeMetaElement;
    _Meta->setName( "SIDREF_array" );
	_Meta->registerClass(domSIDREF_array::create, &_Meta);
	...
	_Meta->setElementSize(sizeof(domSIDREF_array));
	_Meta->validate();
...
daeMetaElement * domSIDREF_array::_Meta = NULL;
