...
public:
	...
	static COLLADA_TYPE::TypeEnum getTypeStatic() const { return COLLADA_TYPE::FX_BASIC_TYPE_COMMON; }
public:
	class domBool;
...
protected:
	 ...
	 * Copy Constructor
	 */
	domFx_basic_type_common( const domFx_basic_type_common &cpy ) : daeElement() { (void)cpy; }
	/**
	 * Overloaded assignment operator
	 */
