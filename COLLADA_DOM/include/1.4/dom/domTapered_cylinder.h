...
public:
	...
	static COLLADA_TYPE::TypeEnum getTypeStatic() const { return COLLADA_TYPE::TAPERED_CYLINDER; }
public:
	class domHeight;
...
protected:
	 ...
	 * Constructor
	 */
	domTapered_cylinder(DAE& dae) : elemHeight(), elemRadius1(), elemRadius2(), elemExtra_array() {}
	/**
	 * Destructor
	 */
