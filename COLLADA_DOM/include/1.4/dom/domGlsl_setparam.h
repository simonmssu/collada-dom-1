...
protected:
	 ...
	 * Constructor
	 */
	domGlsl_setparam_complexType(DAE& dae) : attrRef(), attrProgram(), elemAnnotate_array(), elemGlsl_param_type(), elemArray() {}
	/**
	 * Destructor
	 */
...
public:
	...
	static COLLADA_TYPE::TypeEnum getTypeStatic() const { return COLLADA_TYPE::GLSL_SETPARAM; }
