...
public:
	...
	static COLLADA_TYPE::TypeEnum getTypeStatic() const { return COLLADA_TYPE::CAPSULE; }
public:
	class domHeight;
 ...
 */
	...
	public:
		...
		static COLLADA_TYPE::TypeEnum getTypeStatic() const { return COLLADA_TYPE::RADIUS; }
...
protected:
	 ...
	 * Constructor
	 */
	domCapsule(DAE& dae) : elemHeight(), elemRadius(), elemExtra_array() {}
	/**
	 * Destructor
	 */
	virtual ~domCapsule() {}
