 ...
 */
	...
	protected:
		 ...
		 * Constructor
		 */
		domScene(DAE& dae) : elemInstance_physics_scene_array(), elemInstance_visual_scene(), elemExtra_array() {}
		/**
		 * Destructor
		 */
		virtual ~domScene() {}
