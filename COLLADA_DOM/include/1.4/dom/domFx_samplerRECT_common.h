...
protected:
	 ...
	 * Constructor
	 */
	domFx_samplerRECT_common_complexType(DAE& dae) : elemSource(), elemWrap_s(), elemWrap_t(), elemMinfilter(), elemMagfilter(), elemMipfilter(), elemBorder_color(), elemMipmap_maxlevel(), elemMipmap_bias(), elemExtra_array() {}
	/**
	 * Destructor
	 */
...
public:
	...
	static COLLADA_TYPE::TypeEnum getTypeStatic() const { return COLLADA_TYPE::FX_SAMPLERRECT_COMMON; }
protected:
	/**
	 * Constructor
	 */
	domFx_samplerRECT_common(DAE& dae) {}
	/**
	 * Destructor
	 */
