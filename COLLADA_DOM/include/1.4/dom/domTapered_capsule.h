...
public:
	...
	static COLLADA_TYPE::TypeEnum getTypeStatic() const { return COLLADA_TYPE::TAPERED_CAPSULE; }
public:
	class domHeight;
 ...
 */
	...
	public:
		...
		static COLLADA_TYPE::TypeEnum getTypeStatic() const { return COLLADA_TYPE::HEIGHT; }
 ...
 */
	...
	public:
		...
		static COLLADA_TYPE::TypeEnum getTypeStatic() const { return COLLADA_TYPE::RADIUS1; }
 ...
 */
	...
	public:
		...
		static COLLADA_TYPE::TypeEnum getTypeStatic() const { return COLLADA_TYPE::RADIUS2; }
...
protected:
	 ...
	 * Constructor
	 */
	domTapered_capsule(DAE& dae) : elemHeight(), elemRadius1(), elemRadius2(), elemExtra_array() {}
	/**
	 * Destructor
	 */
	 ...
	 * Copy Constructor
	 */
	domTapered_capsule( const domTapered_capsule &cpy ) : daeElement() { (void)cpy; }
	/**
	 * Overloaded assignment operator
	 */
