...
protected:
	 ...
	 * Constructor
	 */
	domFx_stenciltarget_common_complexType(DAE& dae) : attrIndex(), attrFace(), attrMip(), attrSlice(), _value() {}
	/**
	 * Destructor
	 */
...
protected:
	 ...
	 * Constructor
	 */
	domFx_stenciltarget_common(DAE& dae) : daeElement(dae), domFx_stenciltarget_common_complexType(dae) {}
	/**
	 * Destructor
	 */
