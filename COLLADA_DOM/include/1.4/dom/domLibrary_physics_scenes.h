...
public:
	...
	static COLLADA_TYPE::TypeEnum getTypeStatic() const { return COLLADA_TYPE::LIBRARY_PHYSICS_SCENES; }
...
protected:
	 ...
	 * Constructor
	 */
	domLibrary_physics_scenes(DAE& dae) : attrId(), attrName(), elemAsset(), elemPhysics_scene_array(), elemExtra_array() {}
	/**
	 * Destructor
	 */
