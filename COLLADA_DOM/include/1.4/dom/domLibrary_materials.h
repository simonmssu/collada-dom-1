...
public:
	...
	static COLLADA_TYPE::TypeEnum getTypeStatic() const { return COLLADA_TYPE::LIBRARY_MATERIALS; }
...
protected:
	 ...
	 * Constructor
	 */
	domLibrary_materials(DAE& dae) : attrId(), attrName(), elemAsset(), elemMaterial_array(), elemExtra_array() {}
	/**
	 * Destructor
	 */
	 ...
	 * Copy Constructor
	 */
	domLibrary_materials( const domLibrary_materials &cpy ) : daeElement() { (void)cpy; }
	/**
