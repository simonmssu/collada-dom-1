...
{
public:
	COLLADA_TYPE::TypeEnum getElementType() const { return COLLADA_TYPE::LIBRARY_MATERIALS; }
...
protected:
	 ...
	 * Constructor
	 */
	domLibrary_materials() : attrId(), attrName(), elemAsset(), elemMaterial_array(), elemExtra_array() {}
	/**
	 * Destructor
	 */
