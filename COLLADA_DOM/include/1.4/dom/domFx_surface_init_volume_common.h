 ...
 */
	...
	public:
		...
		static daeInt typeIDStatic() { return 13; }
 ...
 */
	...
	public:
		...
		static daeInt typeIDStatic() { return 14; }
		virtual daeInt typeID() const { return typeIDStatic(); }
	protected:  // Attribute
		xsIDREF attrRef;
...
protected:
	 ...
	 * Constructor
	 */
	domFx_surface_init_volume_common_complexType(DAE& dae) : elemAll(), elemPrimary() {}
	/**
	 * Destructor
	 */
...
public:
	...
	static daeInt typeIDStatic() { return 15; }
	virtual daeInt typeID() const { return typeIDStatic(); }
protected:
	/**
	 * Constructor
