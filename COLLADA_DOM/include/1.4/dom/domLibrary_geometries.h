...
{
public:
	COLLADA_TYPE::TypeEnum getElementType() const { return COLLADA_TYPE::LIBRARY_GEOMETRIES; }
...
protected:
	 ...
	 * Constructor
	 */
	domLibrary_geometries() : attrId(), attrName(), elemAsset(), elemGeometry_array(), elemExtra_array() {}
	/**
	 * Destructor
	 */
