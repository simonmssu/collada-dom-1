...
public:
	...
	static COLLADA_TYPE::TypeEnum getTypeStatic() const { return COLLADA_TYPE::LIBRARY_GEOMETRIES; }
...
protected:
	 ...
	 * Constructor
	 */
	domLibrary_geometries(DAE& dae) : attrId(), attrName(), elemAsset(), elemGeometry_array(), elemExtra_array() {}
	/**
	 * Destructor
	 */
	 ...
	 * Copy Constructor
	 */
	domLibrary_geometries( const domLibrary_geometries &cpy ) : daeElement() { (void)cpy; }
	/**
