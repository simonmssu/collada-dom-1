...
{
public:
	COLLADA_TYPE::TypeEnum getElementType() const { return COLLADA_TYPE::LIBRARY_EFFECTS; }
...
protected:
	 ...
	 * Constructor
	 */
	domLibrary_effects() : attrId(), attrName(), elemAsset(), elemEffect_array(), elemExtra_array() {}
	/**
	 * Destructor
	 */
	 ...
	 * Copy Constructor
	 */
	domLibrary_effects( const domLibrary_effects &cpy ) : daeElement() { (void)cpy; }
	/**
