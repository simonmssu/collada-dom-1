...
{
public:
	COLLADA_TYPE::TypeEnum getElementType() const { return COLLADA_TYPE::SIDREF_ARRAY; }
protected:  // Attributes
/**
 *                  The id attribute is a text string containing the unique
 * identifier of this element. This value                 must be unique within
 * the instance document. Optional attribute.               
 */
	xsID attrId;
/**
...
protected:
	 ...
	 * Constructor
	 */
	domSIDREF_array() : attrId(), attrName(), attrCount(), _value() {}
	/**
	 * Destructor
	 */
	 ...
	 * Copy Constructor
	 */
	domSIDREF_array( const domSIDREF_array &cpy ) : daeElement() { (void)cpy; }
	/**
