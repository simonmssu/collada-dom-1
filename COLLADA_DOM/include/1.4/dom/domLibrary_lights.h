...
{
public:
	COLLADA_TYPE::TypeEnum getElementType() const { return COLLADA_TYPE::LIBRARY_LIGHTS; }
...
protected:
	 ...
	 * Constructor
	 */
	domLibrary_lights() : attrId(), attrName(), elemAsset(), elemLight_array(), elemExtra_array() {}
	/**
	 * Destructor
	 */
	 ...
	 * Copy Constructor
	 */
	domLibrary_lights( const domLibrary_lights &cpy ) : daeElement() { (void)cpy; }
	/**
