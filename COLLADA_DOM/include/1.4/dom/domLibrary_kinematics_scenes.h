...
{
public:
	COLLADA_TYPE::TypeEnum getElementType() const { return COLLADA_TYPE::LIBRARY_KINEMATICS_SCENES; }
...
protected:
	 ...
	 * Constructor
	 */
	domLibrary_kinematics_scenes() : attrId(), attrName(), elemAsset(), elemKinematics_scene_array(), elemExtra_array() {}
	/**
	 * Destructor
	 */
	 ...
	 * Copy Constructor
	 */
	domLibrary_kinematics_scenes( const domLibrary_kinematics_scenes &cpy ) : daeElement() { (void)cpy; }
	/**
