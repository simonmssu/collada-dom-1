...
{
public:
	COLLADA_TYPE::TypeEnum getElementType() const { return COLLADA_TYPE::LIBRARY_CAMERAS; }
...
protected:
	 ...
	 * Constructor
	 */
	domLibrary_cameras() : attrId(), attrName(), elemAsset(), elemCamera_array(), elemExtra_array() {}
	/**
	 * Destructor
	 */
	 ...
	 * Copy Constructor
	 */
	domLibrary_cameras( const domLibrary_cameras &cpy ) : daeElement() { (void)cpy; }
	/**
