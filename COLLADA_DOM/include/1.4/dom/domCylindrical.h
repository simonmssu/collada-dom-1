 ...
 * License. 
 */
#ifndef __domCylindrical_h__
#define __domCylindrical_h__
...
/**
 * This element is similiar to the cylinder element in           COLLADA,
 * but here for brep information a height value is           not neccessary.
 */
class domCylindrical : public daeElement
{
public:
	COLLADA_TYPE::TypeEnum getElementType() const { return COLLADA_TYPE::CYLINDRICAL; }
public:
	class domRadius;
...
protected:
	 ...
	 * Constructor
	 */
	domCylindrical() : elemRadius() {}
	/**
	 * Destructor
	 */
	virtual ~domCylindrical() {}
	/**
	 * Copy Constructor
	 */
	domCylindrical( const domCylindrical &cpy ) : daeElement() { (void)cpy; }
	/**
	 * Overloaded assignment operator
	 */
	virtual domCylindrical &operator=( const domCylindrical &cpy ) { (void)cpy; return *this; }
