 ...
 * License. 
 */
#ifndef __domShells_h__
#define __domShells_h__
...
{
public:
	COLLADA_TYPE::TypeEnum getElementType() const { return COLLADA_TYPE::SHELLS; }
public:
	class domVcount;
...
protected:  // Elements
/**
 * One input elements is needed to define a shell by its faces. @see domInput
 */
	domInputLocalOffset_Array elemInput_array;
	domVcountRef elemVcount;
/**
 *  The indeces of the faces for each shell.  @see domP
 */
	domPRef elemP;
...
protected:
	 ...
	 * Constructor
	 */
	domShells() : attrId(), attrName(), attrCount(), elemInput_array(), elemVcount(), elemP() {}
	/**
	 * Destructor
	 */
	virtual ~domShells() {}
	 ...
	 * Copy Constructor
	 */
	domShells( const domShells &cpy ) : daeElement() { (void)cpy; }
	/**
	 * Overloaded assignment operator
	 */
