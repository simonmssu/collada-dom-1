...
public:
	...
	static COLLADA_TYPE::TypeEnum getTypeStatic() const { return COLLADA_TYPE::LIBRARY_CONTROLLERS; }
...
protected:
	 ...
	 * Constructor
	 */
	domLibrary_controllers(DAE& dae) : attrId(), attrName(), elemAsset(), elemController_array(), elemExtra_array() {}
	/**
	 * Destructor
	 */
