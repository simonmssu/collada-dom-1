...
{
public:
	COLLADA_TYPE::TypeEnum getElementType() const { return COLLADA_TYPE::LIBRARY_CONTROLLERS; }
...
protected:
	 ...
	 * Constructor
	 */
	domLibrary_controllers() : attrId(), attrName(), elemAsset(), elemController_array(), elemExtra_array() {}
	/**
	 * Destructor
	 */
