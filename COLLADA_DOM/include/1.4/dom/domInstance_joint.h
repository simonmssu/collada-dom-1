...
class domInstance_joint : public daeElement
{
public:
	COLLADA_TYPE::TypeEnum getElementType() const { return COLLADA_TYPE::INSTANCE_JOINT; }
...
protected:
	 ...
	 * Constructor
	 */
	domInstance_joint() : attrSid(), attrName(), attrUrl() {}
	/**
	 * Destructor
	 */
	 ...
	 * Copy Constructor
	 */
	domInstance_joint( const domInstance_joint &cpy ) : daeElement() { (void)cpy; }
	/**
