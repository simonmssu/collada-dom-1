 ...
 * License.
 */
#ifndef __domArticulated_system_h__
#define __domArticulated_system_h__
...
{
public:
	COLLADA_TYPE::TypeEnum getElementType() const { return COLLADA_TYPE::ARTICULATED_SYSTEM; }
...
protected:
	 ...
	 * Constructor
	 */
	domArticulated_system() : attrId(), attrName(), elemAsset(), elemKinematics(), elemMotion(), elemExtra_array() {}
	/**
	 * Destructor
	 */
	 ...
	 * Copy Constructor
	 */
	domArticulated_system( const domArticulated_system &cpy ) : daeElement() { (void)cpy; }
	/**
