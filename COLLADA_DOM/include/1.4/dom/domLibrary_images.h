...
{
public:
	COLLADA_TYPE::TypeEnum getElementType() const { return COLLADA_TYPE::LIBRARY_IMAGES; }
...
protected:
	 ...
	 * Constructor
	 */
	domLibrary_images() : attrId(), attrName(), elemAsset(), elemImage_array(), elemExtra_array() {}
	/**
	 * Destructor
	 */
	 ...
	 * Copy Constructor
	 */
	domLibrary_images( const domLibrary_images &cpy ) : daeElement() { (void)cpy; }
	/**
