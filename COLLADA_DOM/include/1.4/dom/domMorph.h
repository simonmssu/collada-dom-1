...
public:
	...
	static COLLADA_TYPE::TypeEnum getTypeStatic() const { return COLLADA_TYPE::MORPH; }
public:
	class domTargets;
 ...
 */
	...
	public:
		...
		static COLLADA_TYPE::TypeEnum getTypeStatic() const { return COLLADA_TYPE::TARGETS; }
...
protected:
	 ...
	 * Constructor
	 */
	domMorph(DAE& dae) : attrMethod(), attrSource(), elemSource_array(), elemTargets(), elemExtra_array() {}
	/**
	 * Destructor
	 */
	virtual ~domMorph() {}
