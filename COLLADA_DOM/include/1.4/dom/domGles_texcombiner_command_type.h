...
protected:
	 ...
	 * Constructor
	 */
	domGles_texcombiner_command_type_complexType(DAE& dae) : elemConstant(), elemRGB(), elemAlpha() {}
	/**
	 * Destructor
	 */
...
public:
	...
	static COLLADA_TYPE::TypeEnum getTypeStatic() const { return COLLADA_TYPE::GLES_TEXCOMBINER_COMMAND_TYPE; }
protected:
	/**
	 * Constructor
	 */
	domGles_texcombiner_command_type(DAE& dae) {}
	/**
	 * Destructor
	 */
