...
{
public:
	COLLADA_TYPE::TypeEnum getElementType() const { return COLLADA_TYPE::SURFACES; }

protected:  // Element
	domSurfaceType_Array elemSurface_array;
...
public:	//Accessors and Mutators
	 ...
	 */
	domSurfaceType_Array &getSurface_array() { return elemSurface_array; }
	/**
	 * Gets the surface element array.
	 * @return Returns a constant reference to the array of surface elements.
	 */
	const domSurfaceType_Array &getSurface_array() const { return elemSurface_array; }
protected:
	/**
	 * Constructor
	 */
	domSurfaces() : elemSurface_array() {}
	/**
	 * Destructor
	 */
	virtual ~domSurfaces() {}
	 ...
	 * Copy Constructor
	 */
	domSurfaces( const domSurfaces &cpy ) : daeElement() { (void)cpy; }
	/**
