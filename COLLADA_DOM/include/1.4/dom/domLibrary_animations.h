...
{
public:
	COLLADA_TYPE::TypeEnum getElementType() const { return COLLADA_TYPE::LIBRARY_ANIMATIONS; }
...
protected:
	 ...
	 * Constructor
	 */
	domLibrary_animations() : attrId(), attrName(), elemAsset(), elemAnimation_array(), elemExtra_array() {}
	/**
	 * Destructor
	 */
	 ...
	 * Copy Constructor
	 */
	domLibrary_animations( const domLibrary_animations &cpy ) : daeElement() { (void)cpy; }
	/**
