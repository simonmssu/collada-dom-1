...
{
public:
	COLLADA_TYPE::TypeEnum getElementType() const { return COLLADA_TYPE::KINEMATICS_SCENE; }
...
protected:
	 ...
	 * Constructor
	 */
	domKinematics_scene() : attrId(), attrName(), elemAsset(), elemInstance_kinematics_model_array(), elemInstance_articulated_system_array(), elemExtra_array() {}
	/**
	 * Destructor
	 */
	 ...
	 * Copy Constructor
	 */
	domKinematics_scene( const domKinematics_scene &cpy ) : daeElement() { (void)cpy; }
	/**
