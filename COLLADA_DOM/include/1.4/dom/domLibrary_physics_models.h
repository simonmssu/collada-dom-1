...
public:
	...
	static COLLADA_TYPE::TypeEnum getTypeStatic() const { return COLLADA_TYPE::LIBRARY_PHYSICS_MODELS; }
...
protected:
	 ...
	 * Constructor
	 */
	domLibrary_physics_models(DAE& dae) : attrId(), attrName(), elemAsset(), elemPhysics_model_array(), elemExtra_array() {}
	/**
	 * Destructor
	 */
