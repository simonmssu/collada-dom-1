...
protected:
	 ...
	 * Constructor
	 */
	domFx_sampler2D_common_complexType(DAE& dae) : elemSource(), elemWrap_s(), elemWrap_t(), elemMinfilter(), elemMagfilter(), elemMipfilter(), elemBorder_color(), elemMipmap_maxlevel(), elemMipmap_bias(), elemExtra_array() {}
	/**
	 * Destructor
	 */
...
public:
	...
	static COLLADA_TYPE::TypeEnum getTypeStatic() const { return COLLADA_TYPE::FX_SAMPLER2D_COMMON; }
protected:
	/**
	 * Constructor
	 */
	domFx_sampler2D_common(DAE& dae) {}
	/**
	 * Destructor
	 */
