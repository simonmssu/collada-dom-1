...
public:
	...
	public:
		...
		static COLLADA_TYPE::TypeEnum getTypeStatic() const { return COLLADA_TYPE::SEMANTIC; }
...
public:
	...
	static COLLADA_TYPE::TypeEnum getTypeStatic() const { return COLLADA_TYPE::COMMON_NEWPARAM_TYPE; }
