...
{
public:
	COLLADA_TYPE::TypeEnum getElementType() const { return COLLADA_TYPE::LIBRARY_NODES; }
...
protected:
	 ...
	 * Constructor
	 */
	domLibrary_nodes() : attrId(), attrName(), elemAsset(), elemNode_array(), elemExtra_array() {}
	/**
	 * Destructor
	 */
	 ...
	 * Copy Constructor
	 */
	domLibrary_nodes( const domLibrary_nodes &cpy ) : daeElement() { (void)cpy; }
	/**
