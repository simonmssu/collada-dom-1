...
#ifndef __intGles_sampler_state_h__
#define __intGles_sampler_state_h__

#include <dae/daeIntegrationObject.h>
#include <dae/daeMetaElement.h>

class intGles_sampler_state;

typedef daeSmartRef<intGles_sampler_state> intGles_sampler_stateRef;
typedef daeTArray<intGles_sampler_stateRef> intGles_sampler_stateArray;
 ...
 */
class intGles_sampler_state : public daeIntegrationObject
{
public: // Constuctor and Destructor
	/**
	 * Default Constructor.
	 */
	intGles_sampler_state();
