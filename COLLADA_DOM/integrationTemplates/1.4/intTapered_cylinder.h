...
#ifndef __intTapered_cylinder_h__
#define __intTapered_cylinder_h__

#include <dae/daeIntegrationObject.h>
#include <dae/daeMetaElement.h>

class intTapered_cylinder;

typedef daeSmartRef<intTapered_cylinder> intTapered_cylinderRef;
typedef daeTArray<intTapered_cylinderRef> intTapered_cylinderArray;

/**
 * A tapered cylinder primitive that is centered on and aligned with the local
 * Y axis.
 */
class intTapered_cylinder : public daeIntegrationObject
{
