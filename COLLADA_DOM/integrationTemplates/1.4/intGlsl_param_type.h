...
#ifndef __intGlsl_param_type_h__
#define __intGlsl_param_type_h__

#include <dae/daeIntegrationObject.h>
#include <dae/daeMetaElement.h>

class intGlsl_param_type;

typedef daeSmartRef<intGlsl_param_type> intGlsl_param_typeRef;
typedef daeTArray<intGlsl_param_typeRef> intGlsl_param_typeArray;

/**
 * A group that specifies the allowable types for GLSL profile parameters.
 */
class intGlsl_param_type : public daeIntegrationObject
{
