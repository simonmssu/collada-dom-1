...
#ifndef __intSphere_h__
#define __intSphere_h__
...
typedef daeSmartRef<intSphere> intSphereRef;
typedef daeTArray<intSphereRef> intSphereArray;

/**
 * A centered sphere primitive.
 */
class intSphere : public daeIntegrationObject
{
