...
daeElementRef
intLibrary_physics_scenes::create(daeInt)
{
	intLibrary_physics_scenesRef ref = new intLibrary_physics_scenes;
	return ref;
}
...
intLibrary_physics_scenes::registerElement()
{
	...
	_Meta->registerClass(intLibrary_physics_scenes::create, &_Meta);
