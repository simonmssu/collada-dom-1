...
#ifndef __intFx_sampler1D_common_h__
#define __intFx_sampler1D_common_h__

#include <dae/daeIntegrationObject.h>
#include <dae/daeMetaElement.h>

class intFx_sampler1D_common;

typedef daeSmartRef<intFx_sampler1D_common> intFx_sampler1D_commonRef;
typedef daeTArray<intFx_sampler1D_commonRef> intFx_sampler1D_commonArray;

/**
 * A one-dimensional texture sampler.
 */
class intFx_sampler1D_common : public daeIntegrationObject
{
public: // Constuctor and Destructor
	/**
	 * Default Constructor.
	 */
	intFx_sampler1D_common();
