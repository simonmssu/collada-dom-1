...
#ifndef __intFx_samplerCUBE_common_h__
#define __intFx_samplerCUBE_common_h__

#include <dae/daeIntegrationObject.h>
#include <dae/daeMetaElement.h>

class intFx_samplerCUBE_common;

typedef daeSmartRef<intFx_samplerCUBE_common> intFx_samplerCUBE_commonRef;
typedef daeTArray<intFx_samplerCUBE_commonRef> intFx_samplerCUBE_commonArray;

/**
 * A texture sampler for cube maps.
 */
class intFx_samplerCUBE_common : public daeIntegrationObject
{
public: // Constuctor and Destructor
	/**
	 * Default Constructor.
	 */
	intFx_samplerCUBE_common();
...
typedef daeSmartRef<intWrap_p> intWrap_pRef;
typedef daeTArray<intWrap_pRef> intWrap_pArray;

class intWrap_p : public daeIntegrationObject
{
public: // Constuctor and Destructor
	/**
	 * Default Constructor.
