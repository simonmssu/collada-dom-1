...
#ifndef __intFx_surface_init_volume_common_h__
#define __intFx_surface_init_volume_common_h__

#include <dae/daeIntegrationObject.h>
#include <dae/daeMetaElement.h>

class intFx_surface_init_volume_common;

typedef daeSmartRef<intFx_surface_init_volume_common> intFx_surface_init_volume_commonRef;
typedef daeTArray<intFx_surface_init_volume_commonRef> intFx_surface_init_volume_commonArray;

class intFx_surface_init_volume_common : public daeIntegrationObject
{
public: // Constuctor and Destructor
	/**
	 * Default Constructor.
	 */
	intFx_surface_init_volume_common();
