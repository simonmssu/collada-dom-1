...
#ifndef __intPhysics_material_h__
#define __intPhysics_material_h__

#include <dae/daeIntegrationObject.h>
#include <dae/daeMetaElement.h>

class intPhysics_material;

typedef daeSmartRef<intPhysics_material> intPhysics_materialRef;
typedef daeTArray<intPhysics_materialRef> intPhysics_materialArray;
 ...
 */
class intPhysics_material : public daeIntegrationObject
{
