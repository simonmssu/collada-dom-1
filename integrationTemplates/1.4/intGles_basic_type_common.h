...
#ifndef __intGles_basic_type_common_h__
#define __intGles_basic_type_common_h__

#include <dae/daeIntegrationObject.h>
#include <dae/daeMetaElement.h>

class intGles_basic_type_common;

typedef daeSmartRef<intGles_basic_type_common> intGles_basic_type_commonRef;
typedef daeTArray<intGles_basic_type_commonRef> intGles_basic_type_commonArray;

/**
 * A group that defines the available variable types for GLES parameters.
 */
class intGles_basic_type_common : public daeIntegrationObject
{
public: // Constuctor and Destructor
	/**
	 * Default Constructor.
	 */
	intGles_basic_type_common();
