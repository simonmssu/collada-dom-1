...
#ifndef __intProfile_CG_h__
#define __intProfile_CG_h__
...
typedef daeSmartRef<intProfile_CG> intProfile_CGRef;
typedef daeTArray<intProfile_CGRef> intProfile_CGArray;

/**
 * Opens a block of CG platform-specific data types and technique declarations.
 */
class intProfile_CG : public daeIntegrationObject
{
