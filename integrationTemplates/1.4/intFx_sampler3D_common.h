...
#ifndef __intFx_sampler3D_common_h__
#define __intFx_sampler3D_common_h__

#include <dae/daeIntegrationObject.h>
#include <dae/daeMetaElement.h>

class intFx_sampler3D_common;

typedef daeSmartRef<intFx_sampler3D_common> intFx_sampler3D_commonRef;
typedef daeTArray<intFx_sampler3D_commonRef> intFx_sampler3D_commonArray;

/**
 * A three-dimensional texture sampler.
 */
class intFx_sampler3D_common : public daeIntegrationObject
{
public: // Constuctor and Destructor
	/**
	 * Default Constructor.
	 */
	intFx_sampler3D_common();
