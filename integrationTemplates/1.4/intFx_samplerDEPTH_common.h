...
#ifndef __intFx_samplerDEPTH_common_h__
#define __intFx_samplerDEPTH_common_h__

#include <dae/daeIntegrationObject.h>
#include <dae/daeMetaElement.h>

class intFx_samplerDEPTH_common;

typedef daeSmartRef<intFx_samplerDEPTH_common> intFx_samplerDEPTH_commonRef;
typedef daeTArray<intFx_samplerDEPTH_commonRef> intFx_samplerDEPTH_commonArray;

/**
 * A texture sampler for depth maps.
 */
class intFx_samplerDEPTH_common : public daeIntegrationObject
{
public: // Constuctor and Destructor
	/**
	 * Default Constructor.
	 */
	intFx_samplerDEPTH_common();
